          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              <div key={index} className={`relative mb-12 ${index % 2 === 0 ? 'md:pr-1/2' : 'md:pl-1/2 md:text-right'}`}>
                ...
                <Card className={`ml-16 md:ml-0 ${index % 2 === 0 ? 'md:mr-8' : 'md:ml-8'} bg-slate-800 border-slate-700 hover:border-blue-500 transition-all duration-300 hover:scale-105`}>
